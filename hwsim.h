...
#ifndef __ETL_HWSIM_H
#define __ETL_HWSIM_H
...
//#undef wiphy_dbg
//#define wiphy_dbg(wiphy, format, args...) pr_info(format, ##args)

extern void etl_rx_fwdingToHwsim(struct sk_buff *skb, u8 radiolen);
#endif /* __ETL_HWSIM_H */
